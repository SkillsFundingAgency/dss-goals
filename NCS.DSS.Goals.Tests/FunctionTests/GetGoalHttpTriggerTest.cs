...
namespace NCS.DSS.Goal.Tests.FunctionTests
{
    ...
    public class GetGoalHttpTriggerTest
    {
        ...
        private IGetGoalsHttpTriggerService _getGoalHttpTriggerService;
        ...
        public void Setup()
        {
            ...
            _resourceHelper = Substitute.For<IResourceHelper>();
            _getGoalHttpTriggerService = Substitute.For<IGetGoalsHttpTriggerService>();
        ...
        public async Task GetGoalHttpTrigger_ReturnsStatusCodeOk_WhenGoalExists()
        {
            ...
            _getGoalHttpTriggerService.GetGoalsAsync(Arg.Any<Guid>()).Returns(Task.FromResult(listOfGoales).Result);
        ...
        {
            return await GetGoalsHttpTrigger.Function.GetGoalsHttpTrigger.Run(
                _request, 
                _log, 
                customerId,
                interactionId,
