...
namespace NCS.DSS.Goal.Tests.FunctionTests
{
    ...
    public class GetGoalByIdHttpTriggerTests
    {
        ...
        private const string ValidActionPlanId = "645427c1-d14d-41f0-b008-923f8d159d14";
        ...
        private IGetGoalsByIdHttpTriggerService _getGoalByIdHttpTriggerService;
        ...
        public void Setup()
        {
            ...
            _getGoalByIdHttpTriggerService = Substitute.For<IGetGoalsByIdHttpTriggerService>();
        ...
        public async Task GetGoalByIdHttpTrigger_ReturnsStatusCodeBadRequest_WhenDssCorrelationIdIsInvalid()
        {
            ...
            // Act
            var result = await RunFunction(InValidId, ValidInteractionId, ValidActionPlanId, ValidSessionId, ValidGoalId);
        ...
        public async Task GetGoalByIdHttpTrigger_ReturnsStatusCodeBadRequest_WhenInteractionIdIsInvalid()
        {
            ...
            // Act
            var result = await RunFunction(ValidCustomerId, InValidId, ValidActionPlanId, ValidSessionId, ValidGoalId);
        ...
        [Test]
        public async Task GetGoalByIdHttpTrigger_ReturnsStatusCodeBadRequest_WhenSessionIdIsInvalid()
        {
            _httpResponseMessageHelper
                .BadRequest(Arg.Any<Guid>()).Returns(x => new HttpResponseMessage(HttpStatusCode.BadRequest));

            // Act
            var result = await RunFunction(ValidCustomerId, ValidInteractionId, ValidActionPlanId, InValidId, ValidGoalId);
        ...
        public async Task GetGoalByIdHttpTrigger_ReturnsStatusCodeBadRequest_WhenGoalIdIsInvalid()
        {
            ...
            // Act
            var result = await RunFunction(ValidCustomerId, ValidInteractionId, ValidActionPlanId, ValidSessionId, InValidId);
        ...
        public async Task GetGoalByIdHttpTrigger_ReturnsStatusCodeNoContent_WhenCustomerDoesNotExist()
        {
            ...
            // Act
            var result = await RunFunction(ValidCustomerId, ValidInteractionId, ValidActionPlanId, ValidSessionId, ValidGoalId);
        ...
        public async Task GetGoalByIdHttpTrigger_ReturnsStatusCodeNoContent_WhenInteractionDoesNotExist()
        {
            ...
            _resourceHelper.DoesSessionResourceExistAndBelongToCustomer(Arg.Any<Guid>(), Arg.Any<Guid>(), Arg.Any<Guid>()).Returns(false);
        ...
        {
            _resourceHelper.DoesCustomerExist(Arg.Any<Guid>()).Returns(true);
            _resourceHelper.DoesSessionResourceExistAndBelongToCustomer(Arg.Any<Guid>(), Arg.Any<Guid>(), Arg.Any<Guid>()).Returns(true);

            _getGoalByIdHttpTriggerService.GetGoalsForCustomerAsync(Arg.Any<Guid>(), Arg.Any<Guid>()).Returns(Task.FromResult<Models.Goal>(null).Result);
        ...
        public async Task GetGoalByIdHttpTrigger_ReturnsStatusCodeOk_WhenGoalExists()
        {
            ...
            _getGoalByIdHttpTriggerService.GetGoalsForCustomerAsync(Arg.Any<Guid>(), Arg.Any<Guid>()).Returns(Task.FromResult(_Goal).Result);
        ...
        private async Task<HttpResponseMessage> RunFunction(string customerId, string interactionId, string actionplanId, string sessionId, string GoalId)
        {
            return await GetGoalsByIdHttpTrigger.Function.GetGoalsByIdHttpTrigger.Run(
                ...
                sessionId,
                _resourceHelper,
                _getGoalByIdHttpTriggerService,
                _loggerHelper,
                _httpRequestHelper,
                _httpResponseMessageHelper,
